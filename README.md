...
> **สำหรับทีมที่ใช้งานจริง (ไม่ใช่นักพัฒนา):** ดู [USER-GUIDE.md](USER-GUIDE.md) — สรุปว่าแต่ละเครื่องมือทำอะไรได้/ไม่ได้บ้าง
> เอกสารนี้ (README) เป็นคู่มือ deploy ทางเทคนิค
